        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-muted-foreground mb-12 leading-relaxed max-w-md">
              I&apos;m always open to discussing new opportunities, creative ideas or technical collaborations. Feel free to reach out!
            </p>

            <div className="space-y-6">
              <Link href="mailto:lokeshofficial0114@gmail.com" className="group flex items-center gap-6 p-4 rounded-2xl hover:bg-white/5 transition-colors -ml-4">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-muted-foreground group-hover:text-white/80 transition-colors">lokeshofficial0114@gmail.com</p>
                </div>
              ...
              <Link href="https://linkedin.com/in/lokeshparasuraman" target="_blank" className="group flex items-center gap-6 p-4 rounded-2xl hover:bg-white/5 transition-colors -ml-4">
                <div className="p-4 rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                  <Linkedin className="w-6 h-6" />
                </div>
                <div className="flex-grow">
                  <h4 className="font-semibold text-white mb-1">LinkedIn</h4>
                  <p className="text-muted-foreground group-hover:text-white/80 transition-colors">linkedin.com/in/lokeshparasuraman</p>
                </div>
                <ArrowRight className="w-5 h-5 text-muted-foreground opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
              </Link>

              <Link href="https://github.com/lokeshparasuraman" target="_blank" className="group flex items-center gap-6 p-4 rounded-2xl hover:bg-white/5 transition-colors -ml-4">
                <div className="p-4 rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                  <Github className="w-6 h-6" />
                </div>
                <div className="flex-grow">
                  <h4 className="font-semibold text-white mb-1">GitHub</h4>
                  <p className="text-muted-foreground group-hover:text-white/80 transition-colors">github.com/lokeshparasuraman</p>
                </div>
                <ArrowRight className="w-5 h-5 text-muted-foreground opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
              </Link>
            </div>
