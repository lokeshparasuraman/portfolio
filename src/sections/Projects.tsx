...
import { Github, ExternalLink, Rocket, Zap, Share2, Layers, CheckCircle2 } from "lucide-react";
...
const projects = [
  {
    ...
    description: "An AI-powered platform for searching and booking flights with a seamless modern UI. Supports high-performance search queries and intelligent comparisons.",
    tech: ["React", "TypeScript", "Express", "PostgreSQL", "Tailwind CSS"],
    live: "https://flight-bookings.vercel.app/",
    icon: <Rocket className="w-12 h-12 text-primary/50 group-hover:text-primary transition-colors" />,
    points: [
      "Built a modern responsive flight search interface with React and Tailwind CSS",
      "Designed database schema in PostgreSQL for caching flight records and user bookings",
      "Developed Express REST APIs to fetch and filter flights based on dates, pricing, and stops"
    ]
  },
  {
    title: "Todo Summarizer",
    description: "A developer logging and productivity tool that summarizes and categorizes entries using AI. Integrates Slack API for seamless notification alerts.",
    ...
    points: [
      "Integrated OpenAI GPT models to summarize developer todo lists into neat reports",
      "Constructed a Slack bot webhook to deliver daily summary updates to specified channels",
      "Stored and structured user credentials and logging history securely using MongoDB"
    ]
  },
  {
    title: "Weather App",
    description: "Real-time weather tracking application with location-based forecasts, displaying weather data via a clean design.",
    ...
    points: [
      "Utilized open weather REST APIs to fetch geolocation forecasts instantly",
      "Designed and coded responsive widgets showing wind speed, humidity, and temperature trends"
    ]
  }
];
  ...
  return (
    <section id="projects" className="w-full max-w-6xl py-32 px-4 mx-auto">
      ...
      >
        ...
        {/* Flagship SaaS/Blockchain Project */}
        <motion.div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              ...
              <div className="lg:col-span-7 p-8 md:p-12 flex flex-col">
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  A Web3 and secure ledger application designed to manage legal evidence chain-of-custody. 
                  Leverages cryptographic verification and immutable logging to prevent unauthorized editing, tampering, 
                  or deletion of critical database evidence records.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  <div>
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        "Tamper Alerts & Logging",
                        "Audit Trial Summarizer"
                      ].map((f) => (
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-primary uppercase tracking-[0.2em] mb-4">Security Stack</h4>
                    <div className="space-y-4">
                      <div className="bg-white/5 p-3 rounded-xl border border-white/5">
                        <div className="text-xl font-bold text-white">SHA-256</div>
                        <div className="text-[10px] text-muted-foreground uppercase">Cryptographic Hashing</div>
                      </div>
                      <div className="bg-white/5 p-3 rounded-xl border border-white/5">
                        <div className="text-xl font-bold text-white">Zero Tampering</div>
                        <div className="text-[10px] text-muted-foreground uppercase">Integrity Score</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-10">
                  {["React", "Node.js", "MongoDB", "Blockchain Logic", "Express", "SHA-256", "Tailwind CSS"].map((t) => (
                ...
                <div className="flex flex-wrap gap-4 mt-auto pt-8 border-t border-white/5">
                  <Link href="https://github.com/lokeshparasuraman/CHAIN-OF-CUSTODY" target="_blank">
